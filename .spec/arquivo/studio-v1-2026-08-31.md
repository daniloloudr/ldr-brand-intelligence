> ⚠️ **HISTÓRICO — não atualizar.** Esta é a v1 da spec do Estúdio, vigente de
> jul/2026 a 31/08/2026. Foi substituída por
> [`features/estudio.md`](../features/estudio.md) (v2), que reorganiza o módulo
> em Criar · Campanhas · Fluxos · Biblioteca, tira o Copiloto dos pilares e
> introduz peça/versão, execução, parecer e agentes.
>
> Serve para entender **como o Estúdio foi construído** e por quê — o de-para
> entre este modelo e o da v2 está em `features/estudio.md` § 12.
